	...
	render() {
		return (
			<div>
				...
				<p>
					Luke Morrice built the Optify app as a Free app. This SERVICE is
					provided by Luke Morrice at no cost and is intended for use as is.
				</p>
				<p>
				...
				<p>
					...
					Terms and Conditions, which is accessible at Optify unless otherwise
				...
				<p>
					...
					but not limited to first name, surname and email address. The
				...
				<p>This policy is effective as of 2020-06-22</p>
				<p>
					<strong>Contact Us</strong>
				</p>
				<p>
					If you have any questions or suggestions about my Privacy Policy, do
					not hesitate to contact me at lukemorrice@icloud.com.
				</p>
				<p>
